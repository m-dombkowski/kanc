...
const credentials = [
  { icon: GraduationCap, text: 'Absolwent Wydziału Prawa i Administracji' },
  { icon: Award, text: 'Wpis na listę radców prawnych Okręgowej Izby Radców Prawnych w Warszawie' },
  { icon: Briefcase, text: 'Wieloletnie doświadczenie w obsłudze prawnej przedsiębiorców i osób prywatnych' },
  { icon: Scale, text: 'Specjalizacja w prawie cywilnym, gospodarczym, administracyjnym i medycznym' },
]
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            <div>
              ...
              >
                Kancelaria świadczy usługi prawne na najwyższym poziomie, łącząc dogłębną
                znajomość prawa z praktycznym doświadczeniem zdobytym w toku wieloletniej
                pracy zawodowej. Reprezentujemy Klientów zarówno przed sądami powszechnymi,
                jak i w postępowaniach administracyjnych i arbitrażowych.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                możliwościach i potencjalnych ryzykach.
              </motion.p>
            </div>
          ...
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-20 items-start">
              ...
              <div className="relative">
                ...
                <div className="relative bg-navy-800 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-7">
                    <p className="font-serif text-2xl text-white mb-1">Jacek Dombkowski</p>
            ...
            <div className="lg:col-span-3">
              ...
              <motion.p
                ...
                className="font-sans font-light text-white/55 text-[15px] leading-relaxed mb-5"
              >
                Radca prawny z wieloletnim stażem zawodowym. Specjalizuje się w prawie cywilnym,
                gospodarczym, administracyjnym, prawie zamówień publicznych oraz prawie medycznym,
                świadcząc usługi zarówno dla przedsiębiorców, jak i osób fizycznych.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 16 }}
                whileInView={{ opacity: 1, y: 0 }}
